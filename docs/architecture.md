...
- Live event mode: Step 4 GitHub repository signals are ingested into `external_event_raw`, deduped by source/content hash, normalized into `market_events`, and can trigger the same seven-agent workflow.
